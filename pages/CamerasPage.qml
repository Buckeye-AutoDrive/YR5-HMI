...
Item {
        ...
        ListModel {
            id: cameraModel
            ListElement { label: "Center"; code: "center"; streamUrl: "rtsp://10.42.0.1:8555/cam0" }
            ListElement { label: "Left";   code: "left";   streamUrl: "rtsp://192.168.1.231:8554/cam1"   }
            ListElement { label: "Right";  code: "right";  streamUrl: "rtsp://192.168.1.231:8554/cam2"  }
            ListElement { label: "Bumper"; code: "bumper"; streamUrl: "rtsp://192.168.1.231:8554/cam2" }
        }
